...
(function($,document){
    ...
    $.fn.AjaxFlagMenu = function(Options){
        ...
        function AjaxFlagMenuItem(_Title,_onOutIcon,_onClickIcon,_HtmlStatusContent,_url,_data){
            ...
            function Carga(url1,inicio,strFbList,strSubAng)
            {
                var objeto;
                if(url1 == context + 'SNSAngelGuardFB/settingsSNSAngelGuard_Angels.jsp'){
                    saveSelectionAngels();
                    objeto = $.ajax({
                        url: url1,
                        type: 'POST',
                        ...
                        complete: function(){
                            ...
                            loadContactsEd(titleName,titleEmail);
                            habilitarGuardar();
                            cerrarLoader();
                        }
                    });
            ...
            function cargarobjeto(objeto)
            {
                if(objeto.readyState == 3){
                    document.getElementById(Options.ajaxContent).innerHTML='<img src="' + context + 'SNSAngelGuardFB/resources/Loading.gif" alt="cargando" />';
                    $("#"+Options.ajaxContent).html('<img src="' + context + 'SNSAngelGuardFB/resources/Loading.gif" alt="cargando" />');
                }
            ...
            this.cargaInicio = function (url,strFbList,strSubAng,strTitleName,strTitleEmail,strMenSave,strMenWait,strMenAviso){
            ...
            _AjaxFlagMenuItem.click(function(){
                if($("#hdAngels").val() == '' && $("#hdAngelsGoogleSelected").val() == '' && $("#hdAngelsEd").val() == '' && _url == context + 'SNSAngelGuardFB/settingsSNSAngelGuard_Vigilants.jsp'){
                    alert(menAviso);
                }else{
                    if(!_AjaxFlagMenuItem.hasClass(Options.onClickClass)){
                        muestraLoader(menSave,menWait);
                        ...
                        _AjaxFlagMenuItem.corner("4px");
                        Carga(_url,false,titleFbList, titleAngelSettAng);
                    }
                }
            });
        };
